...
export function TableComponent(state) {
    ...
    const [data, setData] = useState(
        [
            { id: 18372, name: 'Anna', color: 'red' },
            { id: 54928, name: 'Ben', color: 'blue' },
            { id: 73491, name: 'Clara', color: 'green' },
        ],
        [
            { id: 29184, name: 'David', color: 'yellow' },
            { id: 83275, name: 'Ella', color: 'purple' },
            { id: 41726, name: 'Finn', color: 'orange' },
        ],
        [
            { id: 36589, name: 'Gina', color: 'cyan' },
            { id: 79013, name: 'Hugo', color: 'pink' },
            { id: 60237, name: 'Ivy', color: 'red' },
        ],
    )
